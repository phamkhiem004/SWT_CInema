...
public class ShowTimeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<ShowTime> screeningList = showTimeDAO.getAllScreeningTimes();
        request.setAttribute("screeningList", screeningList);
       
        request.getRequestDispatcher("screeningTime.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        if ("deactivate".equals(action)) {
            ...
            showTimeDAO.deactivateShowTime(showTimeID);
        }
        response.sendRedirect("ShowTimeServlet");
    }
