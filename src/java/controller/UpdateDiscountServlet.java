 ...
 */
@WebServlet(name = "UpdateDiscountServlet", urlPatterns = {"/UpdateDiscountServlet"})
public class UpdateDiscountServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Discount discount = new Discount(discountID, discountName, discountCode, discountPercentage, expiryDate, updatedAt, updatedAt, imageURL, description);

        discountDAO.updateDiscount(discount);
        response.sendRedirect("discounts.jsp"); // Điều hướng về trang danh sách discount sau khi cập nhật
    }
