...
public class DeleteMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        MovieDAO discountDAO = new MovieDAO();
        boolean isUpdated = discountDAO.deactivateMovie(movieID);

        if (isUpdated) {
            response.sendRedirect("moviesinfo.jsp?success=status_changed");
        } else {
            response.sendRedirect("moviesinfo.jsp?error=status_change_failed");
        }
    }
